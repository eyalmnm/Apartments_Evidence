...
public class CanNotBeDeletedFragment extends DialogFragment {
    ...
    public void onResume() {
        super.onResume();
        int width = getResources().getDimensionPixelSize(R.dimen.nested_building_can_not_delete_dialog_width);
        int height = getResources().getDimensionPixelSize(R.dimen.nested_building_can_not_delete_dialog_height);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_can_not_delete_dialog, null);
